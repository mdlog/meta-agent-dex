  ...
  return [
    ...
    },
    {
      ...
      actions: [
        ...
        { kind: "hover", selector: 'th:has-text("Finished")', ms: 2000 },
        ...
        { kind: "hover", selector: 'a.primary-button:has-text("This session")', ms: 2000 },
      ],
    },
    {
      ...
      actions: [
        ...
        { kind: "scrollTo", selector: "text=Order book", ms: 1200 },
    ...
    },
    {
      ...
      actions: [
        ...
        { kind: "hover", selector: "text=/^(Cash|NAV) · nav\\(\\)$/", ms: 2000 },
        { kind: "hover", selector: "text=Unaccounted · unaccounted()", ms: 2000 },
        { kind: "scrollTo", selector: "text=The vault holds it", at: "The operator key", ms: 1500 },
        { kind: "hover", selector: "text=Operator", ms: 1500 },
        { kind: "click", selector: 'button:has-text("Trades ·")', route: `/agents/${slug}`, at: "Every row in the tape" },
        { kind: "scrollTo", selector: 'th:has-text("Transaction")', ms: 1200 },
        { kind: "explorer", selector: `table a[href*="${new URL(take.explorer).host}"]`, at: "IOC order", ms: 2500 },
      ],
    },
    {
      id: "05-settlement",
      ...
      actions: [
        ...
        { kind: "goto", path: "/settlement", route: "/settlement", at: "and DreamDEX paid" },
        { kind: "scrollTo", selector: "text=Settled and voided sessions", ms: 1200 },
        { kind: "hover", selector: `tr:has-text("${name}")`, ms: 2500 },
      ],
    },
    {
      id: "06-receipts",
